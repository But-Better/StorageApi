...
@Entity
public class AddressCsv implements Serializable {
	 ...
	 */
	public AddressCsv(String name, String companyName, String street, String city, String postCode, String country) {
		this.name = name;
	...
	public boolean equals(Object o) {
		...
		if (o == null || getClass() != o.getClass())
			return false;
		AddressCsv address = (AddressCsv) o;
